...
class TestQubit:
    ...
    def time_transmon_get_spectrum_vs_paramvals(self):
        ...
        qbt.get_spectrum_vs_paramvals('ng', ng_list, evals_count=4, subtract_ground=False, get_eigenstates=True)
    ...
    def time_tunabletransmon_get_spectrum_vs_paramvals(self):
        ...
        qbt.get_spectrum_vs_paramvals('flux', flux, evals_count=4, subtract_ground=False, get_eigenstates=True)
    ...
    def time_cos2phi_get_spectrum_vs_paramvals(self):
        ...
        qbt.get_spectrum_vs_paramvals('flux', flux_list, evals_count=3, subtract_ground=False, get_eigenstates=True)
