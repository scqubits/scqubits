...
# *****************************************************************************
# NVIDIA-TEST REVIEW — this file matches branch nvidia-test (uncommitted working copy).
# Merge was undone; benchmark HEAD is 493ad4f9. Inspect changes:
#   git diff 493ad4f9 nvidia-test -- scqubits/utils/cuquantum_utils.py
# Also see repo-root: nvidia_test_review.diff
# *****************************************************************************
