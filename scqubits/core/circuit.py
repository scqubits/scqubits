...
class SubSystem(base.QubitBaseClass, serializers.Serializable):
    ...
    def __init__(
        ...
        self._hamiltonian_sym_for_numerics: sm.Expr = hamiltonian_symbolic
    ...
    def _kron_operator(
        ...
        Parameters
        ----------
        operator : Union[csc_matrix, ndarray]
