...
class Dcpr_dc(base.QubitBaseClass, serializers.Serializable):
    ...
    def __init__(self, EJ, EC, EL, ELA, x, flux_c, flux_d, kbt, truncated_dim=None):
        self.EJ = EJ
        self.EC = EC
        self.EL = EL
        self.ELA = ELA
    ...
    def flux(self):
        return 2 * self.flux_c

    def fluxa(self):
        return -(self.flux_c + self.flux_d)
