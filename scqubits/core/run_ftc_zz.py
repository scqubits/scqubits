...
FTC_grounded = scq.FluxoniumTunableCouplerGrounded(EJa=E_Ja, EJb=E_Jb, EC_twoqubit=np.inf,
                                               ...
                                               fluxonium_minus_truncated_dim=5, h_o_truncated_dim=5)
...
def run_ftc_zz(
    ...
    E00 = FTC_grounded.fourth_order_energy_shift(
    ...
    param_dict = {"highest_exc_q": highest_exc_q, "highest_exc_m": highest_exc_m, "highest_exc_p": highest_exc_p,
                  ...
                  "flux_c": flux_c, "flux_q": flux_q}
    filepath = "out/"+str(idx).zfill(5)+"_ZZ_shift_vs_flux.h5py"
