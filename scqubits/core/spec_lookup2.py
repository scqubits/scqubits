...
if TYPE_CHECKING:
    from scqubits import HilbertSpace, Sweep, SpectrumData
...
def check_sync_status(func: Callable) -> Callable:
    ...
    def wrapper(self, *args, **kwargs):
        if self._out_of_sync:
            warnings.warn(
                "SCQUBITS\nSpectrum lookup data is out of sync with systems "
                "originally involved in generating it. This will generally lead to "
                "incorrect results. Consider regenerating the lookup data "
...
class SpectrumLookup(serializers.Serializable):
    ...
    def __init__(
        self,
        framework: "Union[Sweep, HilbertSpace, None]",
