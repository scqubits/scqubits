...
class SpectrumLookupMixin:
    ...
    @property
    def _bare_produc_states_labels(self) -> List[Tuple[int, ...]]:
        """
    ...
    def spectrum_lookup_sweep(self):
        self._data["dressed_indices"] = self._generate_lookup()

    def _generate_lookup(self) -> utils.NamedSlotsNdarray:
        """
        ...
        return utils.NamedSlotsNdarray(dressed_indices, self.parameters.ordered_dict)
    ...
    def bare_index(
        ...
        param_indices = param_indices or self._current_param_indices
        try:
            lookup_position = self._data["dressed_indices"][param_indices].index(
                dressed_index
            )
        except ValueError:
            return None
