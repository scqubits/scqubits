...
class SymbolicCircuit(serializers.Serializable):
    ...
    TODO: there should be no method options that are only there for debugging. remove
    ...
    def _parse_branches(
        ...
        branches = []
        branch_var_dict = {} # dictionary which stores the init values of all the
        # variables defined in input string
