...
class CircuitRoutines(SubsystemTreeMixin, ABC):
    ...
    Hamiltonian evaluation.  Subsystem-tree construction (decomposing a
    parent Hamiltonian into child subsystems and wiring up the
    HilbertSpace) lives on the :class:`SubsystemTreeMixin` base.
    Concrete subclasses are responsible for initializing the declared
    attributes; this class only mixes in the behaviour that operates
    on them.
    """
