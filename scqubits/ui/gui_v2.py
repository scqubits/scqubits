...
class GUI_V2:
    ...
    def __init__(self):
        ...
        self.plot_output: Output = Output(
            layout=Layout(width=gui_defaults.WIDTH, 
                          height=gui_defaults.PLOT_HEIGHT)
        )
        self.tab_widget: Tab = Tab(
            layout=Layout(width=gui_defaults.WIDTH, 
                          height=gui_defaults.TAB_HEIGHT)
        )
        ...
        starting_qubit = self.qubit_and_plot_ToggleButtons["qubit_buttons"].get_interact_value()
    ...
    def initialize_qubit_and_plot_ToggleButtons(self) -> None:
        ...
        self.qubit_and_plot_ToggleButtons = {
            "qubit_buttons": ToggleButtons(
                options=gui_defaults.supported_qubits,
                description="Qubits:"
            ),
    ...
    def initialize_display(self) -> None:
        ...
        display(qubit_and_plot_choice_display, self.tab_widget, manual_update_display, self.plot_output)
    ...
    def plot_option_layout_refresh(self, change) -> None:
        ...
        plot_options_and_qubit_params_list[0] = self.plot_option_layout()
    ...
    def wavefunctions_plot_refresh(self, change) -> None:
        value_dict = {
            'mode_value': self.qubit_plot_options_widgets["mode_dropdown"].get_interact_value(),
            **self.get_current_values()
            }
        ...
        if isinstance(self.active_qubit, scq.FullZeroPi):
            ...
            return
        elif isinstance(self.active_qubit, 
            (scq.FluxQubit, scq.ZeroPi, scq.Cos2PhiQubit)):
            ...
            value_dict["scale_value"] = self.qubit_plot_options_widgets["wavefunction_scale_slider"].get_interact_value()
            value_dict["eigenvalue_states"] = self.qubit_plot_options_widgets[
    ...
    def plot_option_layout(self) -> VBox:
        current_plot_option = self.qubit_and_plot_ToggleButtons["plot_buttons"].get_interact_value()
        VBox_layout = Layout(object_fit='contain',
                             width='50%')
    ...
    def energy_scan_layout(self) -> Tuple[Dropdown, FloatRangeSlider, Checkbox, IntSlider]:
    ...
    def matelem_scan_layout(self) -> Tuple[Dropdown, Dropdown, FloatRangeSlider, IntSlider, Dropdown]:
    ...
    def wavefunctions_layout(self):
        ...
        if isinstance(self.active_qubit, scq.FullZeroPi):
            ...
            if isinstance(self.active_qubit, (scq.ZeroPi, scq.FluxQubit, scq.Cos2PhiQubit)):
                plot_options_widgets_tuple = (
                    which_widget,
                    self.qubit_plot_options_widgets["mode_dropdown"],
                )
    ...
    def wavefunctions_plot(
        ...
        **params:
        ...
        with self.plot_output:
            plt.cla()
            if isinstance(self.active_qubit, 
                (scq.FluxQubit, scq.ZeroPi, scq.Cos2PhiQubit)):
