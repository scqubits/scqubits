...
class TestHilbertSpace:
    ...
    def test_HilbertSpace_op_in_dressed_basis(self):
        ...
        op1 = qt.Qobj(
            hilbert_space.op_in_dressed_eigenbasis(op_callable_or_tuple=osc_a.annihilation_operator)[
                0:10, 0:10
            ]
        )
        op2 = qt.Qobj(
        ...
        op3 = qt.Qobj(
            hilbert_space.op_in_dressed_eigenbasis(
                op_callable_or_tuple=(osc_a.annihilation_operator(), osc_a), op_in_bare_eigenbasis=True
            )[0:10, 0:10]
        )
        op4 = qt.Qobj(
            hilbert_space.op_in_dressed_eigenbasis(
                op_callable_or_tuple=(osc_a.annihilation_operator(), osc_a), op_in_bare_eigenbasis=False
            )[0:10, 0:10]
        )
    ...
    def test_HilbertSpace_op_in_dressed_basis_native_vs_bare_basis(self):
        ...
        hilbert_space.generate_lookup()
        op1 = hilbert_space.op_in_dressed_eigenbasis(op_callable_or_tuple=tmon.n_operator)
        n_op_bare_eigenbasis_v2 = tmon.n_operator(energy_esys=True)
        op2 = hilbert_space.op_in_dressed_eigenbasis(
            op_callable_or_tuple=(n_op_bare_eigenbasis_v2, tmon), op_in_bare_eigenbasis=True
        )
        assert op1 == op2
