...
circ = scq.Circuit.from_yaml(DATADIR + "circuit_zeropi.yaml",  ext_basis="harmonic", 
initiate_sym_calc=False)
system_hierarchy = [[1,3], [2]]

circ.initiate_circuit(transformation_matrix=None, system_hierarchy=system_hierarchy,
...
def test_plot_potential():
    circ.plot_potential(θ1=circ._default_grid_phi.make_linspace() , 
    θ2=circ._default_grid_phi.make_linspace(), θ3=0)