...
class TestTransmon(BaseTest):
    ...
    def init_qbt(self):
        self.qbt = Transmon(EJ=30.02,
                            EC=1.2,
                            ng=0.3,
                            ncut=31)

    _EVALS_REFERENCE = np.asarray([-21.84381856, -6.17518551, 8.01366695, 20.04897106, 30.54312385, 38.7071573])
    _EVECS_REFERENCE = np.asarray([2.82596779e-50, 4.02326328e-50, 5.90227556e-49,
    ...
    _EVALS_REFERENCE2 = np.asarray([[-21.84390814, -6.17107609, 7.93584546, 20.84011423],
    ...
    _MATELEM_REFERENCE = np.asarray([[2.99957402e-01 - 0.j, -9.02867276e-01 - 0.j, -1.26536183e-03 - 0.j,
    ...
    def test_get_spectrum_vs_paramvals(self):
        ...
        return self.get_spectrum_vs_paramvals('ng', ng_list, self._EVALS_REFERENCE2)
    ...
    def test_matrixelement_table(self):
        return self.matrixelement_table('n_operator', self._MATELEM_REFERENCE,  evals_count=16)
