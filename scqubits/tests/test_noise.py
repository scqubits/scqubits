...
data = {
    ...
    'FluxQubit': np.array([44697811.55376147, 44697796.19976752,  1822725.05439264, 1685277.68169804, np.inf,
                           842638.84084902]),
    'ZeroPi': np.array([ 3806664.01882053, 41202847.68864658, np.inf, np.inf, np.inf,  3484716.71474053])
}
