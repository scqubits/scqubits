...
class TestCircuit:
    ...
    def test_sym_lagrangian():
        ...
        - ["C", 2, 4, 0.02]
        """
        REFERENCE = "<bound method Printable.__str__ of EJ*cos(θ1 + θ3) + EJ*cos(1.0*(2πΦ_{1}) + θ1 - 1.0*θ3) + 6.25625*\\dot{θ_1}**2 + 6.25*\\dot{θ_2}**2 + 0.00625*\\dot{θ_3}**2 - 0.009*θ2**2 + 0.002*θ2*θ3 - 0.009*θ3**2>"
